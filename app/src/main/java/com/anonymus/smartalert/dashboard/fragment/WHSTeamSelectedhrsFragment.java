...
public class WHSTeamSelectedhrsFragment extends Fragment  {

//    private Button mButtonMessage;
//    private Button mButtonRepeat;
//    private TextView mTextMenu;

    public WHSTeamSelectedhrsFragment() {
        // Required empty public constructor
    }

    public static WHSTeamSelectedhrsFragment newInstance() {
        Bundle args = new Bundle();
        WHSTeamSelectedhrsFragment fragment = new WHSTeamSelectedhrsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_whs_selection_hrs, container, false);
