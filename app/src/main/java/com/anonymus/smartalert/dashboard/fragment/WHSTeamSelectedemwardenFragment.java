...
public class WHSTeamSelectedemwardenFragment extends Fragment  {

//    private Button mButtonMessage;
//    private Button mButtonRepeat;
//    private TextView mTextMenu;

    public WHSTeamSelectedemwardenFragment() {
        // Required empty public constructor
    }

    public static WHSTeamSelectedemwardenFragment newInstance() {
        Bundle args = new Bundle();
        WHSTeamSelectedemwardenFragment fragment = new WHSTeamSelectedemwardenFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_whs_selection_emwarden, container, false);
        ...
        Button a4 = (Button) rootView.findViewById(R.id.a4);
